...
- Garcia-Donato, G. and Forte, A. (2018). Bayesian Testing, Variable Selection and Model Averaging in Linear Models using R with BayesVarSel. *The R Journal, 10*(1): 155–174. Retrieved from [https://journal.r-project.org/archive/2018/RJ-2018-021/index.html](https://journal.r-project.org/archive/2018/RJ-2018-021/index.html)
